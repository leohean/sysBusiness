...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a href="../funcionarios/funcionarios.php" class="link"><i class="fas fa-user-friends"></i> Funcionários</a></li>
    ...
    <div class="top">
        ...
        <div class="container">
            ...
            <form>
		        <div class="display-4"><?php echo $dados['nome'] ?><button type="submit" style="background: none; color: inherit; border: none; padding: 0; font: inherit; cursor: pointer; outline: inherit;"><i class="fas fa-check-circle"></i></button></div>
            </form>

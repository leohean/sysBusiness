<?php
    ...
    try{
        ...
        if(isset($_POST['btn-etapa'])):
            ...
            if((strtotime($dataInicioEtapa)<strtotime($hoje))&&(strtotime($dataFimEtapas)<strtotime($hoje))):
            ...
            if(empty($errosEtapa)):
                ...
                $stmtEtapa=$pdo->prepare('INSERT INTO cad_etapa(nome,descri,data_inicio,data_fim,id_projeto) VALUES (:nomeEtapa,:descricaoEtapa,:dataInicioEtapa,:dataFimEtapa,:codProjeto)');
                ...
                $stmtEtapa->bindParam(':codProjeto',$_SESSION['id_projeto']);
        ...
        $errosCadastroEtapa[]="Não foi possível cadastrar etapa";
    }finally{
        $pdo=null;
    }
